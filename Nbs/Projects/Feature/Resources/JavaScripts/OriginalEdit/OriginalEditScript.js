...
function showTulipMenu(span) {
  ...
  if (left + menuRect.width > window.scrollX + window.innerWidth) left = window.scrollX + window.innerWidth - menuRect.width - 10;
  let top = window.scrollY + spanRect.top - menuRect.height - 10;
  if (top < window.scrollY + fixedHeaderHeight) top = window.scrollY + spanRect.bottom + 10;
